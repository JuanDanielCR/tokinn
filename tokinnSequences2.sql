...
--INSERT usuario
INSERT INTO public.usuario(id_usuario, id_facebook, apellido_paterno, apellido_materno, nombre, direccion, email, pass, telefono)VALUES (nextval('t01_usuario_seq'), null, 'Castillo', 'Reyes', 'Juan Daniel', 'Calle Orquídeas M26 LT.37 No 32 Coacalco Estado de México', 'castilloreyesjuan@gmail.com', 'admin123', '3313979662');
INSERT INTO public.usuario(id_usuario, id_facebook, apellido_paterno, apellido_materno, nombre, direccion, email, pass, telefono)VALUES (nextval('t01_usuario_seq'), null, 'Castillo', 'Reyes', 'Eduardo Armando', 'Calle Orquídeas M26 LT.37 No 32 Coacalco Estado de México', 'armandocreyes@gmail.com', 'prueba123', '5526471243');
INSERT INTO public.usuario(id_usuario, id_facebook, apellido_paterno, apellido_materno, nombre, direccion, email, pass, telefono)VALUES (nextval('t01_usuario_seq'), null, 'Jiménez', 'Chávez', 'Luis Gerardo', 'Sur 14 No 10 San Agustin 1a Secc Ecatepec de Morelos', 'lgjc1im11@gmail.com', 'luis123', '5523446668');
INSERT INTO public.usuario(id_usuario, id_facebook, apellido_paterno, apellido_materno, nombre, direccion, email, pass, telefono)VALUES (nextval('t01_usuario_seq'), null, 'Martinez', 'Ibañez', 'Esteban Pablo', 'Calle Venezuela M32 LT.7 No 25 Ojo de Agua Estado de México', 'este_p@hotmail.com', 'esteban123', '5552698546');
INSERT INTO public.usuario(id_usuario, id_facebook, apellido_paterno, apellido_materno, nombre, direccion, email, pass, telefono)VALUES (nextval('t01_usuario_seq'), null, 'Olvera', 'Neria', 'Giselle Yamile', 'Calle 22 M5 LT.3 Iztapalapa Estado de México', 'gigi_N@gmail.com', 'giselle123', '5513598785');
INSERT INTO public.usuario(id_usuario, id_facebook, apellido_paterno, apellido_materno, nombre, direccion, email, pass, telefono)VALUES (nextval('t01_usuario_seq'), null, 'Lopez', 'Orozco', 'Diego Efrain', 'Avenida Eduardo Molina M2 LT.5 Gustavo A. Madero Ciudad de México', 'lopord@gmail.com', 'diego123', '5546568912');
INSERT INTO public.usuario(id_usuario, id_facebook, apellido_paterno, apellido_materno, nombre, direccion, email, pass, telefono)VALUES (nextval('t01_usuario_seq'), null, 'Luna', 'Reyes', 'Eduardo', 'Nuevo paseo de Louisiana M15 LT.10 Gustavo A. Madero Ciudad de México', 'eduardol@gmail.com', 'eduardo123', '5510527496');
--INSERT tipo_cuenta
